const menu = [
  ...
  {category:'Healthy Bowls',slug:'healthy-bowls',tagline:'Balanced fuel · bold flavour',items:[['Acai Bowl','Açaí topped with banana, berries, granola and peanut butter',46,'assets/bowl-acai.webp','VG'],['Blue Crash Bowl','A vibrant blue smoothie bowl with mango, banana, berries and granola',44,'assets/bowl-blue-crash.webp','VG'],['Bowl','A berry smoothie bowl with avocado, banana, cucumber and granola',46,'assets/bowl-original.webp','VG'],['Bowl 2','A colourful wellness bowl with fruit, vegetables, nuts and granola',49,'assets/bowl-2.webp','VG'],['Bowl 4','A pink smoothie bowl topped with tropical fruit, berries and pomegranate',48,'assets/bowl-4.webp','VG'],['Tropical Glow Bowl','A tropical green bowl with avocado, mango, pineapple and berries',44,'assets/bowl-tropical-glow.webp','VG'],['Watermelon Feta','Fresh watermelon, feta, chia seeds and mint',25,'assets/bowl-watermelon-feta.webp','V']]},
  {category:'Protein Bars',slug:'protein-bars',tagline:'Clean energy · ready to go',items:[['Fignuts','Figs, nuts and seeds pressed into a naturally energising bar',16,'assets/protein-bar-fignuts.webp','VG'],['Klalnana','A rich cacao and nut protein bar with a smooth finish',24,'assets/protein-bar-klalnana.webp','VG'],['Nutri Tropix','A layered tropical fruit and nut energy bar',16,'assets/protein-bar-nutri-tropix.webp','VG'],['Nutty Date Delight Ball','Chocolate-coated date and nut energy balls',16,'assets/protein-bar-nutty-date-delight-ball.webp','VG']]},
