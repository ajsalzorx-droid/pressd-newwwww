const menu = [
  {category:'Breakfast',slug:'breakfast',tagline:'Fresh mornings · made to nourish',items:[['Avacado Toast with Poached Eggs','Creamy avocado toast topped with poached eggs and served with a fresh garden salad',39,'assets/avacado-toast-poached-eggs.png',''],['Avacado Toast with Salmon','Creamy avocado toast topped with salmon and served with a fresh garden salad',49,'assets/avacado-toast-salmon.png','']]},
  {category:'Hot Beverages',slug:'hot-beverages',tagline:'Warm cups · better moments',items:[['Americano','Espresso lengthened with hot water for a smooth, bold cup',19,'assets/hot-americano.png',''],['Cappuccino / Latte','Espresso with silky steamed milk and a smooth foam finish',24,'assets/hot-cappuccino-latte.png',''],['Expresso','A rich, full-bodied single shot',17,'assets/hot-expresso.png',''],['Hot Matcha Latte','Matcha whisked with smooth steamed milk',26,'assets/hot-matcha-latte.png','V'],['Iced V60','Hand-brewed filter coffee served over ice',28,'assets/hot-iced-v60.png',''],['Mochaccino','Espresso, chocolate and silky steamed milk',25,'assets/hot-mochaccino.png',''],['Piccolo','A short espresso softened with textured milk',24,'assets/hot-piccolo.png',''],['Tea Selections','A curated selection of classic hot teas',18,'assets/hot-tea-selections.png','V'],['Tisane Tea','A soothing caffeine-free herbal infusion',20,'assets/hot-tisane-tea.png','VG'],['V60','Hand-poured filter coffee with a clean, aromatic finish',26,'assets/hot-v60.png','']]},
  {category:'Salads',slug:'salads',tagline:'Fresh · crisp · satisfying',items:[['Blood Sugar Level','Chickpeas, avocado, cucumber, tomatoes, radish and olives',25,'assets/salad-blood-sugar-level.png','VG'],['Chicken Ceasar','Grilled chicken, avocado, baby gem, parmesan and croutons',29,'assets/salad-chicken-ceasar.png',''],['Colon Cleaning','Beetroot, carrot and cabbage in a bright citrus dressing',25,'assets/salad-colon-cleaning.png','VG'],['Flat Stomach','Green peas, cucumber and red cabbage with fresh herbs',25,'assets/salad-flat-stomach.png','VG'],['Tabbouloleh Salad','Couscous, cucumber, tomato, herbs and red onion',25,'assets/salad-tabbouloleh.png','VG'],['Triple Berries Salad','Spinach, strawberries, blueberries, blackberries and feta',29,'assets/salad-triple-berries.png','V']]},
  {category:'Sandwiches',slug:'sandwiches',tagline:'Freshly made · full of flavour',items:[['Beef Pastrami','Beef pastrami, melted cheese, lettuce and onion',38,'assets/sandwich-beef-pastrami.png',''],['Chickado','Chicken, avocado, tomato, cucumber and creamy dressing',38,'assets/sandwich-chickado.png',''],['Halloumi Avacado','Halloumi, avocado, cucumber and tomato',38,'assets/sandwich-halloumi-avacado.png','V'],['Halloumi Pesto','Halloumi, pesto, cucumber and tomato',38,'assets/sandwich-halloumi-pesto.png','V'],['Labneh','Labneh, cucumber, tomato, olives and greens',38,'assets/sandwich-labneh.png','V'],['Melted Cheese','Warm melted cheese and tomato',38,'assets/sandwich-melted-cheese.png','V'],['Smoked Salmon','Smoked salmon, cucumber and cream cheese',38,'assets/sandwich-smoked-salmon.png',''],['Smoked Turkey','Smoked turkey, melted cheese, tomato and pesto',38,'assets/sandwich-smoked-turkey.png','']]},
  {category:'Healthy Bowls',slug:'healthy-bowls',tagline:'Balanced fuel · bold flavour',items:[['Acai Bowl','Açaí topped with banana, berries, granola and peanut butter',46,'assets/bowl-acai.png','VG'],['Blue Crash Bowl','A vibrant blue smoothie bowl with mango, banana, berries and granola',44,'assets/bowl-blue-crash.png','VG'],['Bowl','A berry smoothie bowl with avocado, banana, cucumber and granola',46,'assets/bowl-original.png','VG'],['Bowl 2','A colourful wellness bowl with fruit, vegetables, nuts and granola',49,'assets/bowl-2.png','VG'],['Bowl 4','A pink smoothie bowl topped with tropical fruit, berries and pomegranate',48,'assets/bowl-4.png','VG'],['Tropical Glow Bowl','A tropical green bowl with avocado, mango, pineapple and berries',44,'assets/bowl-tropical-glow.png','VG'],['Watermelon Feta','Fresh watermelon, feta, chia seeds and mint',25,'assets/bowl-watermelon-feta.png','V']]},
  {category:'Protein Bars',slug:'protein-bars',tagline:'Clean energy · ready to go',items:[['Fignuts','Figs, nuts and seeds pressed into a naturally energising bar',16,'assets/protein-bar-fignuts.png','VG'],['Klalnana','A rich cacao and nut protein bar with a smooth finish',24,'assets/protein-bar-klalnana.png','VG'],['Nutri Tropix','A layered tropical fruit and nut energy bar',16,'assets/protein-bar-nutri-tropix.png','VG'],['Nutty Date Delight Ball','Chocolate-coated date and nut energy balls',16,'assets/protein-bar-nutty-date-delight-ball.png','VG']]},
  {category:'Cakes & Pastries',slug:'cakes-pastries',tagline:'Freshly baked · perfectly paired',items:[['Banana Bread','A soft, moist slice of classic banana bread',16,'assets/pastry-banana-cake.png',''],['Blueberry Muffin','A tender muffin baked with juicy blueberries',16,'assets/pastry-blueberry-muffin.png',''],['Brownies','A rich, fudgy chocolate brownie',16,'assets/pastry-brownies.png',''],['Chocolate Muffin','A soft chocolate muffin with a deeply cocoa-rich finish',16,'assets/pastry-chocolate-muffin.png','']]},
  ...
  {category:'Cold Beverages',slug:'cold-beverages',tagline:'Chilled · clean · refreshing',items:[['Blue Lagoon Mojito','A bright citrus-mint cooler with sparkling blue lagoon flavour',28,'assets/cold-blue-lagoon-mojito.png','VG'],['Blueberry Mojito','Blueberry, fresh mint, citrus and sparkling soda',28,'assets/cold-blueberry-mojito.png','VG'],['Classic Mojito','Fresh lime, mint and sparkling soda',26,'assets/cold-classic-mojito.png','VG'],['Passion Fruit Mojito','Passion fruit, fresh mint, lime and sparkling soda',28,'assets/cold-passion-fruit-mojito.png','VG'],['Evian Water','Natural mineral water from the French Alps',12,'assets/cold-evian-water.png','VG'],['Vitamin Well Upgrade','Lemon-cactus vitamin drink with magnesium and zinc',20,'assets/cold-vitamin-well-upgrade.png','VG'],['C4 Energy Drink','Zero-sugar performance energy drink',20,'assets/cold-c4-energy-drink.png','VG'],['Cold Drip Coffee','Slow-dripped cold coffee with a smooth, bold finish',26,'assets/cold-drip-coffee.png',''],['Ginger Ice Tea','Chilled tea infused with bright, warming ginger',20,'assets/cold-ginger-ice-tea.png','VG'],['Ice Americano','Double espresso poured over ice',18,'assets/cold-iced-americano.png',''],['Ice Matcha Latte','Matcha shaken with chilled milk and ice',29,'assets/cold-iced-matcha-latte.png','V'],['Iced Spanish Latte','Espresso, chilled milk and gentle sweetness',27,'assets/cold-iced-spanish-latte.png',''],['Passion Fruit Ice Tea','Chilled tea brightened with tropical passion fruit',20,'assets/cold-passion-fruit-ice-tea.png','VG'],['Peach Ice Tea','Smooth chilled tea with ripe peach flavour',20,'assets/cold-peach-ice-tea.png','VG'],['Rasberry Cano','A refreshing raspberry-infused iced Americano',24,'assets/cold-raspberry-cano.png',''],['Perrier Sparkling Water','Classic Perrier natural sparkling mineral water',12,'assets/cold-perrier-bottle.png','VG'],['Perrier Sparkling Water with Lemon','Perrier sparkling water served over ice with lemon',12,'assets/cold-perrier-glass.png','VG']]},
