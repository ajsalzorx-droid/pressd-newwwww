...
customizeModal.innerHTML=`<button class="customize-close close-btn" type="button" aria-label="Close drink customization">×</button><div class="modal-header"><span class="customize-eyebrow eyebrow">MAKE IT YOURS</span><h2 id="customize-title">Customize Your Drink</h2><h3 class="customize-product-name"></h3></div><form><div class="customize-grid"><section class="custom-section coffee-section"><h4>COFFEE</h4><div class="customize-options option-grid coffee-options"><label class="option-card"><input type="radio" name="coffee" value="Caffeinated" checked><span>Caffeinated</span></label><label class="option-card"><input type="radio" name="coffee" value="Decaf"><span>Decaf</span></label></div></section><section class="custom-section milk-section"><h4>MILK</h4><div class="customize-options option-grid milk-options">${milkOptions.map((option,index)=>`<label class="option-card"><input type="radio" name="milk" value="${option}"${index===0?' checked':''}><span>${option}</span></label>`).join('')}</div></section><section class="custom-section add-on-section"><h4>ADD-ONS</h4><div class="customize-options option-grid addon-options">${addonOptions.map(option=>`<label class="option-card checkbox-card"><input type="checkbox" name="addons" value="${option}"><span>${option}</span></label>`).join('')}</div></section><section class="custom-section customize-comment comment-section"><h4>COMMENT / SPECIAL INSTRUCTIONS</h4><p>Tell us what you’d like to reduce, remove, or add to this drink.</p><textarea id="customize-instructions" name="instructions" maxlength="500" rows="4" placeholder="Add your comment or special instructions..."></textarea></section></div><p class="customize-note" aria-live="polite"></p><button class="customize-save save-btn" type="submit">SAVE SELECTION</button></form>`;
